...
async function bootstrap() {
  ...
  app.use(
    cors({
      origin: ['http://localhost:5000', 'http://www.kanban.exposemycode.com', 'http://kanban.exposemycode.com', 'https://kanban.exposemycode.com', 'https://www.kanban.exposemycode.com'],
      credentials: true,
    }),
  );
  app.use(
